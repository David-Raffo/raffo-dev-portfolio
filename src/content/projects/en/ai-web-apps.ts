...
export default {
  ...
  facts: [
    { label: "Apps", value: "4 · all of them live" },
      ...
      props: {
        items: [
          ...
          },
          {
            ...
            description:
              "Drop dozens of images, pick one of five AI models and download them all as a ZIP. Self-hosted, it runs in memory on your own server. The live demo runs the models right in your browser.",
