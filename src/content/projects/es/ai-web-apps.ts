...
export default {
  ...
  sites: [
    ...
    { label: "Quitafondos", url: "https://quitafondos.raffo.dev/" },
  ],
  facts: [
    { label: "Apps", value: "4 · todas publicadas" },
      ...
      props: {
        items: [
          ...
          },
          {
            ...
            description:
              "Suelta decenas de imágenes, elige uno de cinco modelos de IA y descárgalas todas en un ZIP. Autoalojado corre en memoria en tu propio servidor, y la demo en vivo ejecuta los modelos en tu propio navegador.",
            ...
            live: "https://quitafondos.raffo.dev/",
